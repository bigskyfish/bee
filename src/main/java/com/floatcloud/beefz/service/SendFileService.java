...
public class SendFileService {
    ...
    public void sendFileToRemote(List<ServerConfigPojo> serverList) throws FileNotFoundException {
        try {
            ...
            FileInputStream uninstall = new FileInputStream(srcPath + FileConstant.UN_INSTALL);
            if (serverList != null && !serverList.isEmpty()) {
                ...
                serverList.forEach(serverConfigPojo -> {
                    ...
                    try {
                        ...
                        FileDistributeUtil.uploadFile(serverConfigPojo, setup, FileConstant.SET_UP_SH);
                        FileDistributeUtil.uploadFile(serverConfigPojo, uninstall, FileConstant.UN_INSTALL);
                    } catch (Exception e) {
